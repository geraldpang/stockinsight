                  ...
                  <tbody>
                    {[
                      ...
                      },
                      {
                        ...
                        cur: ov.hi52 > 0 ? (price / ((ov.hi52+ov.lo52)/2) * pe).toFixed(2) : "-"
                      },
                      {
                      ...
                      },
                      {
                        ...
                        fn: function(r) {
                          var h = history[r.date] || {};
                          var psVal = h.revPS && h.revPS > 0 && r.price ? r.price / h.revPS : 0;
                          return psVal > 0 && ov.ltG > 0 ? (psVal / ov.ltG).toFixed(2) : "-";
                        },
