            ...
            <div className="nav-desktop" style={{ background:"#c8f000", padding:"7px 20px", display:"grid", gridTemplateColumns:"minmax(0,200px) 1fr auto", alignItems:"center", gap:0, minWidth:0 }}>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                <div style={{ display:"flex", flexDirection:"column", gap:0 }}>
                  ...
                  <span style={{ fontSize:9, color:"rgba(0,0,0,0.35)", fontWeight:500, letterSpacing:"0.02em", lineHeight:1 }}>v1.66</span>
                </div>
                        ...
                        <div style={{border:"1px solid #d8cdb8",borderTop:"none",borderRadius:"0 0 8px 8px",marginBottom:16}}>
                          ...
                          {(function(){
                            ...
                            return <TRow label="Golden/Death Cross (50-day vs 200-day MA)"
                              ...
                              context={crsG!==null?"The 50-day average is currently "+(crsG>0?crsG.toFixed(1)+"% above":Math.abs(crsG).toFixed(1)+"% below")+" the 200-day average."+_crossAgeCtx+" When the 50-day crosses above the 200-day it is called a Golden Cross (bullish), and when it crosses below it is called a Death Cross (bearish). These are major long-term signals watched by professional fund managers worldwide.":null}
      ...
      <nav style={{ position:"relative", zIndex:10, padding:"0 32px", height:52, display:"flex", alignItems:"center", justifyContent:"space-between" }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:0 }}>
            ...
            <span style={{ fontSize:9, color:"rgba(200,240,0,0.4)", fontWeight:500, letterSpacing:"0.02em", lineHeight:1 }}>v1.66</span>
          </div>
        </div>
